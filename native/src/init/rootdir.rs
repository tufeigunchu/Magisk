...
on init
    exec {0} 0 0 -- /system/bin/sh -c "/system/bin/cat /vendor/etc/fstab.default |/system/bin/sed 's/fileencryption/fillencryption/g' > /dev/fstab && /system/bin/mount -o bind /dev/fstab /vendor/etc/fstab.default"
